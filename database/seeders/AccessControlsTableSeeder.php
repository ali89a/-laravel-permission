...
class AccessControlsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['name' => 'batch-upload', 'guard_name' => 'admin', 'group_name' => 'batch-upload'],
        ];
        ...
        $data = [
            ...
            ['role_id' => 5, 'model_type' => 'App\Models\Admin', 'model_id' => 6],
            ['role_id' => 5, 'model_type' => 'App\Models\Admin', 'model_id' => 7],
            ['role_id' => 1, 'model_type' => 'App\Models\Admin', 'model_id' => 8],
        ];
