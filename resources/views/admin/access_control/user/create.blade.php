                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a class="btn btn-sm active-color" href="{{route('user.users.index')}}">&nbsp;User List</a>
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    {{ BootForm::horizontal(['model'=>$model, 'store' => 'user.users.store', 'update' => 'user.users.update','enctype'=>'multipart/form-data','autocomplete'=>'off']) }}
